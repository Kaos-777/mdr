...
You don’t need to know any programming to use mdr. It makes your Markdown work faster and easier.
...
- **Windows:**
  ...
  2. If Windows warns about unknown apps, choose “More info” and then “Run anyway.”
...
If you want, you can copy or move the mdr file to a folder that is part of your system’s PATH. This allows running `mdr` from any terminal window without navigating to its folder.

---

## ✨ Using mdr

Once mdr is running, you will see a menu and a simple interface. Here’s how to get around:

- Use the arrow keys to move through menus.
- Press Enter to select options or open files.
- To open a Markdown file, choose “Open File” and type the path.
...
mdr has helpful hints and shortcuts inside the app, so don’t worry about memorizing commands right away.
...
- Keyboard shortcuts speed up your work. Look for their list under the “Help” menu.
